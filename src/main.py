...
from src.parser.schemas import Bet, Market
...
@app.get("/arbs/", status_code=status.HTTP_200_OK, response_model=Bet)
...
@app.get("/update_koefs/", status_code=status.HTTP_200_OK, response_model=Market)
